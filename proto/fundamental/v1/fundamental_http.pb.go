...
func RegisterFundamentalHTTPServer(s *http.Server, srv FundamentalHTTPServer) {
	r := s.Route("/")
	r.GET("/v1/company/fundamentals", _Fundamental_Get3_HTTP_Handler(srv))
	r.GET("/healthz", _Fundamental_Health7_HTTP_Handler(srv))
}

func _Fundamental_Get3_HTTP_Handler(srv FundamentalHTTPServer) func(ctx http.Context) error {
