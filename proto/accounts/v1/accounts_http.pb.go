...
func RegisterAccountsHTTPServer(s *http.Server, srv AccountsHTTPServer) {
	...
	r.GET("/v1/accounts", _Accounts_List1_HTTP_Handler(srv))
	r.POST("/v1/account", _Accounts_Create0_HTTP_Handler(srv))
	r.GET("/healthz", _Accounts_Health7_HTTP_Handler(srv))
}
...
func _Accounts_List1_HTTP_Handler(srv AccountsHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Accounts_Health7_HTTP_Handler(srv AccountsHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
