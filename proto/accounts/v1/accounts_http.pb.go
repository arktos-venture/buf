...
func RegisterAccountsHTTPServer(s *http.Server, srv AccountsHTTPServer) {
	...
	r.GET("/healthz", _Accounts_Health12_HTTP_Handler(srv))
}
...
func _Accounts_List4_HTTP_Handler(srv AccountsHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Accounts_Health12_HTTP_Handler(srv AccountsHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
