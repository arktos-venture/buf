...
func RegisterNotificationsHTTPServer(s *http.Server, srv NotificationsHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/notifications/{account}", _Notifications_Create7_HTTP_Handler(srv))
...
func _Notifications_Create7_HTTP_Handler(srv NotificationsHTTPServer) func(ctx http.Context) error {
