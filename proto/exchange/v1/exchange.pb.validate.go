...
// Validate checks the field values on ExchangeShortReplies with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ExchangeShortReplies) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ExchangeShortReplies with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ExchangeShortRepliesMultiError, or nil if none found.
func (m *ExchangeShortReplies) ValidateAll() error {
	return m.validate(true)
}

func (m *ExchangeShortReplies) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetResults() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ExchangeShortRepliesValidationError{
			...
			if err := v.Validate(); err != nil {
				return ExchangeShortRepliesValidationError{
					field:  fmt.Sprintf("Results[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return ExchangeShortRepliesMultiError(errors)
	}
	return nil
}

// ExchangeShortRepliesMultiError is an error wrapping multiple validation
// errors returned by ExchangeShortReplies.ValidateAll() if the designated
// constraints aren't met.
type ExchangeShortRepliesMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ExchangeShortRepliesMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ExchangeShortRepliesMultiError) AllErrors() []error { return m }

// ExchangeShortRepliesValidationError is the validation error returned by
// ExchangeShortReplies.Validate if the designated constraints aren't met.
type ExchangeShortRepliesValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ExchangeShortRepliesValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ExchangeShortRepliesValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ExchangeShortRepliesValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ExchangeShortRepliesValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ExchangeShortRepliesValidationError) ErrorName() string {
	return "ExchangeShortRepliesValidationError"
}

// Error satisfies the builtin error interface
func (e ExchangeShortRepliesValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sExchangeShortReplies.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ExchangeShortRepliesValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ExchangeShortRepliesValidationError{}
