...
type NewsReplies struct {
	...
	Results []*NewsReplies_Result `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
...
func (x *NewsReplies) GetResults() []*NewsReplies_Result {
	if x != nil {
		return x.Results
	}
	return nil
...
type NewsReplies_Result struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *NewsReplies_Result) Reset() {
	*x = NewsReplies_Result{}
	if protoimpl.UnsafeEnabled {
...
func (x *NewsReplies_Result) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NewsReplies_Result) ProtoMessage() {}

func (x *NewsReplies_Result) ProtoReflect() protoreflect.Message {
	mi := &file_proto_news_v1_news_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NewsReplies_Result.ProtoReflect.Descriptor instead.
func (*NewsReplies_Result) Descriptor() ([]byte, []int) {
	return file_proto_news_v1_news_proto_rawDescGZIP(), []int{1, 0}
}

func (x *NewsReplies_Result) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *NewsReplies_Result) GetLink() string {
	if x != nil {
		return x.Link
	}
	return ""
...
func (x *NewsReplies_Result) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *NewsReplies_Result) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
var file_proto_news_v1_news_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x22, 0xde, 0x01, 0x0a, 0x0b, 0x4e, 0x65, 0x77, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x69,
	0x65, 0x73, 0x12, 0x35, 0x0a, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x6e, 0x65, 0x77, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4e, 0x65,
	0x77, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	...
	0x81, 0x01, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69,
	0x74, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65,
	0x12, 0x12, 0x0a, 0x04, 0x6c, 0x69, 0x6e, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x6c, 0x69, 0x6e, 0x6b, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x03, 0x20, 0x03,
	...
	,
	...
	0x75, 0x66, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6e, 0x65, 0x77, 0x73, 0x2f, 0x76, 0x31,
	0x3b, 0x76, 0x31, 0x4e, 0x65, 0x77, 0x73, 0x92, 0x41, 0x8c, 0x02, 0x12, 0x79, 0x0a, 0x09, 0x4e,
	0x65, 0x77, 0x73, 0x20, 0x41, 0x50, 0x49, 0x73, 0x12, 0x09, 0x4e, 0x65, 0x77, 0x73, 0x20, 0x41,
...
var file_proto_news_v1_news_proto_goTypes = []interface{}{
	...
	(*NewsReplies)(nil),           // 1: news.v1.NewsReplies
	(*NewsReplies_Result)(nil),    // 2: news.v1.NewsReplies.Result
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_proto_news_v1_news_proto_depIdxs = []int32{
	2, // 0: news.v1.NewsReplies.results:type_name -> news.v1.NewsReplies.Result
	3, // 1: news.v1.NewsReplies.Result.created_at:type_name -> google.protobuf.Timestamp
	0, // 2: news.v1.News.Search:input_type -> news.v1.NewsRequest
	1, // 3: news.v1.News.Search:output_type -> news.v1.NewsReplies
...
func file_proto_news_v1_news_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_news_v1_news_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NewsReplies_Result); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
