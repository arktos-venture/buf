...
func RegisterOrdersHTTPServer(s *http.Server, srv OrdersHTTPServer) {
	...
	r.PATCH("/v1/orders/{account}/{currency}/{orderUUID}", _Orders_Update5_HTTP_Handler(srv))
...
func _Orders_Update5_HTTP_Handler(srv OrdersHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
