...
func (c *strategyClient) Execute(ctx context.Context, in *StrategyRequest, opts ...grpc.CallOption) (*StrategyReply, error) {
	out := new(StrategyReply)
	err := c.cc.Invoke(ctx, "/strategy_results.v1.Strategy/Execute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStrategyServer) Execute(context.Context, *StrategyRequest) (*StrategyReply, error) {
...
func _Strategy_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/strategy_results.v1.Strategy/Execute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StrategyServer).Execute(ctx, req.(*StrategyRequest))
	}
